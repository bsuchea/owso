            ...
            <div class="md:grid md:grid-cols-3 md:gap-6 mt-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium text-gray-900">ថ្ងៃទីខែឆ្នាំ</h3>

                        <p class="mt-1 text-sm text-gray-600">
                            សូមបំពេញថ្ងៃទីខែឆ្នាំឲ្យបានត្រឹមត្រូវមុននឹងធ្វើការបោះពុម្ព បណ្ណអនុញ្ញាត និងកំណត់បង្ហាញរឿង
                        </p>
                    </div>
                </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-5">
                                    ...
                                    <input class="form-input rounded-md shadow-sm mt-1 block w-full"
                                           id="name" type="text" wire:model="dateKh"
                                           autofocus="autofocus">
                                    <x-jet-input-error for="dateKh" class="mt-2"/>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-5">
                                    ...
                                    <input class="form-input rounded-md shadow-sm mt-1 block w-full"
                                           id="name" type="text" wire:model="dateGen">
                                    <x-jet-input-error for="dateGen" class="mt-2"/>
                                </div>
                            </div>
                        </div>
