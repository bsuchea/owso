        ...
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    សូមបញ្ចូលឈ្មោះអាជីវករ(ម្ចាស់អាជីវកម្ម ឬអ្នកតំណាង) ឱ្យបានត្រឹមត្រូវទៅតាមព័ត៌មាននៅក្នុងអត្តសញ្ញាណប័ណ្ណដែលបានដាក់ពាក្យស្នើសុំ
                </p>
            </div>
        </div>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-7 gap-6">
                            ...
                            <div class="col-span-3 sm:col-span-1">
                                <label for="last_name" class="block text-sm font-medium text-gray-700">ភេទ</label>
                            ...
                            <div class="col-span-3 sm:col-span-2">
                                <label for="national" class="block text-sm font-medium text-gray-700">សញ្ជាតិ</label>
                            ...
                            <div class="col-span-7 sm:col-span-3 lg:col-span-3">
                                ...
                                <select name="customer_province" id="customer_province" wire:model="customer_province"
                                        class="form-input rounded-md shadow-sm mt-1 block w-full">
                                    <option value="">-- ជ្រើសរើស --</option>
                                    @if(count($pro) > 0)
                                        @foreach($pro as $p)
                            ...
                            <div class="col-span-7 sm:col-span-4 lg:col-span-4">
                                ...
                                <select name="customer_district" id="customer_district" wire:model="customer_district"
                                        class="form-input rounded-md shadow-sm mt-1 block w-full">
                                    <option value="">-- ជ្រើសរើស --</option>
                                    @if(count($dis) > 0)
                                        @foreach($dis as $p)
                            ...
                            <div class="col-span-7 sm:col-span-2  lg:col-span-2">
                                <label for="country" class="block text-sm font-medium text-gray-700">ឃុំ/សង្កាត់</label>
                                <select name="customer_commune" id="customer_commune" wire:model="customer_commune"
                                        class="form-input rounded-md shadow-sm mt-1 block w-full">
                                    <option value="">-- ជ្រើសរើស --</option>
                                    @if(count($com) > 0)
                                        @foreach($com as $p)
                            ...
                            <div class="col-span-7 sm:col-span-2">
                                ...
                                <select name="customer_village" id="customer_village" wire:model="customer_village"
                                        class="form-input rounded-md shadow-sm mt-1 block w-full">
                                    <option value="">-- ជ្រើសរើស --</option>
                                    @if(count($vil) > 0)
                                        @foreach($vil as $p)
                            ...
                            <div class="col-span-3 sm:col-span-2">
                                ...
                                <input type="text" name="customer_street" id="customer_street" wire:model="customer_street"
                                       class="form-input rounded-md shadow-sm mt-1 block w-full">
                                <x-jet-input-error for="customer_street" class="mt-2"/>
                            </div>

                            <div class="col-span-3 sm:col-span-1">
                                <label for="country" class="block text-sm font-medium text-gray-700">ក្រុមទី </label>
                                <input type="text" name="customer_group" id="customer_group" wire:model="customer_group"
                                       class="form-input rounded-md shadow-sm mt-1 block w-full">
                                <x-jet-input-error for="customer_group" class="mt-2"/>
                            </div>

                            <div class="col-span-3 sm:col-span-1">
                                <label for="country" class="block text-sm font-medium text-gray-700">ផ្ទះលេខ </label>
                                <input type="text" name="customer_home" id="customer_home" wire:model="customer_home"
                                       class="form-input rounded-md shadow-sm mt-1 block w-full">
                            ...
                            <div class="col-span-7 sm:col-span-3 lg:col-span-3">
                                ...
                                <input type="text" name="customer_phone" id="customer_phone" wire:model="customer_phone"
                                       class="form-input rounded-md shadow-sm mt-1 block w-full">
                            ...
                            <div class="col-span-7 sm:col-span-3 lg:col-span-3">
                                ...
                                <input type="text" name="customer_email" id="customer_email" wire:model="customer_email"
                                       class="form-input rounded-md shadow-sm mt-1 block w-full">
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            <label for="first_name" class="block text-sm font-medium text-gray-700">សេវា </label>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="last_name" class="block text-sm font-medium text-gray-700">អាជីវកម្ម </label>
                            <input type="text" name="business_type" id="business_type" wire:model="business_type"
                                       class="form-input rounded-md shadow-sm mt-1 block w-full">
                                <x-jet-input-error for="business_type" class="mt-2"/>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            <label for="first_name" class="block text-sm font-medium text-gray-700">នាមករណ៍ </label>
                            <input type="text" name="brand_name_kh" id="brand_name_kh" wire:model="brand_name_kh"
                                       class="form-input rounded-md shadow-sm mt-1 block w-full">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="last_name" class="block text-sm font-medium text-gray-700">នាមករណ៍
                                ភាសាបរទេស </label>
                            <input type="text" name="brand_name_en" id="brand_name_en" wire:model="brand_name_en"
                                       class="form-input rounded-md shadow-sm mt-1 block w-full">
                                <x-jet-input-error for="brand_name_en" class="mt-2"/>
                        </div>

                        <div class="col-span-6 sm:col-span-2">
                            <label for="state" class="block text-sm font-medium text-gray-700">ខេត្ត/រាជធានី</label>
                            <input type="text" name="state" value="បាត់ដំបង" readonly
                                   class="form-input rounded-md shadow-sm mt-1 block w-full">
                        </div>

                        <div class="col-span-6 sm:col-span-2">
                            <label for="city" class="block text-sm font-medium text-gray-700">ស្រុក/ក្រុង/ខណ្ឌ </label>
                        ...
                        <div class="col-span-3 sm:col-span-2">
                            <label for="street_address" class="block text-sm font-medium text-gray-700">ភូមិ </label>
